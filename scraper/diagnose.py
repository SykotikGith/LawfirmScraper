"""Diagnostic: verify 3 new Workday leads, plus check whether White &
Case's newer myworkdaysite.com URL format still works with our existing
WorkdayAdapter (which assumes the older {tenant}.{pod}.myworkdayjobs.com
pattern) by hitting the same underlying CXS API directly.
...
def check_white_case_new_domain() -> None:
    ...
    # The recruiting front-end the user found:
    front_end = (
        "https://wd1.myworkdaysite.com/recruiting/whitecase/External"
    )
